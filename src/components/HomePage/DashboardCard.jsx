const DashboardCard = ({ title, description, cta }) => (
  <div className="bg-white rounded-2xl border border-soft p-6 shadow-sm flex flex-col items-center text-center">
    ...
    <button className="mt-auto bg-emerald-600 hover:bg-emerald-700 text-white text-sm px-5 py-2 rounded-xl transition">
      {cta} →
    </button>
  </div>
);
